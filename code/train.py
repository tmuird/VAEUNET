...
def train(args):
    ...
    # Configure datasets
    logging.info(f'Loading datasets with patch size: {args.patch_size}')
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        val_results = evaluate(model, val_loader, device, args.amp)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--use-attention', action='store_true', default=True, help='Use attention in model')
